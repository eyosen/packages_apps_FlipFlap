...
public class EventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (com.android.internal.util.aicp.content.Intent.ACTION_LID_STATE_CHANGED.equals(intent.getAction())) {
            PowerManager powerManager = (PowerManager) context.getSystemService(
                    Context.POWER_SERVICE);
            BatteryManager batMan = (BatteryManager) context.getSystemService(
                    Context.BATTERY_SERVICE);
            int lidState = intent.getIntExtra(com.android.internal.util.aicp.content.Intent.EXTRA_LID_STATE, -1);
